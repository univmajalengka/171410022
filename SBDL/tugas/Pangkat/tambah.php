...
<body>
	...
	<div class="main">
		<div class="isimain">
			<form method="POST" enctype="multipart/form-data">
				<h1><font size="5" style="text-align: left;">Tambah Pangkat : </font></h1><br>
				<table width="430px" border="0">
					<tr>
						<td>Kode Pangkat</td>
						<td>:</td>
						<td><input type="text" placeholder="Contoh : KD22" name="kd_pangkat" maxlength="50" autocomplete required></td>
					</tr>
					<tr>
						<td>Nama Pangkat</td>
						<td>:</td>
						<td><input type="text" placeholder="Contoh : Staff Pengawasan" name="nama_pangkat" maxlength="50" autocomplete required></td>
					</tr>
					<tr>
	...
	<?php
		...
		if (isset($_POST['save'])) {
			...
			$sql = "INSERT INTO tabel_pangkat VALUES('$kd_pangkat','$nama_pangkat')";
			$link = koneksi_db();
